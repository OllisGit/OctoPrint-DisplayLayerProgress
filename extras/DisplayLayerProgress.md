...
description: Displays the current processing layer and the percentage in Printer Display and top NavBar
author: Olli
license: AGPLv3
...
http://plugins.octoprint.org/plugin/DisplayLayerProgress/
